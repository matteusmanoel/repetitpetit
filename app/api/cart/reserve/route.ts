...
/**
 * `POST /api/cart/reserve` — reserva atômica de uma peça para a sessão
 * anônima de carrinho (docs/03-architecture.md, docs/04-data-model.md, D14).
 *
 * Body JSON: `{ "productId": "<uuid>" }`
 * Cookie: `rp_cart_session` (criado se ausente)
 */
