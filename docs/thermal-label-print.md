...
- Nome da loja (`NEXT_PUBLIC_STORE_NAME` / marca **Repeti Petite**)
...
| Nome da loja errado na etiqueta | Usar `Repeti Petite` em `NEXT_PUBLIC_STORE_NAME` (ver `.env.example` e D99) |
